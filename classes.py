...
class InferenceAxtree:
    ...
    def __init__(self, scrape_info: InferencePageState, special_actions = None, use_scrape = True):
        ...
        for indefinite_action in special_actions:
            self.tree_str += f"[{count}]" + ' {' + indefinite_action.action.special_effect + '}' + "\n"
            self.debug_tree += f"[{count}]" + ' {' + indefinite_action.action.special_effect + '}' + "\n"
            self.live_actions.append(indefinite_action)
            self.live_action_effects.append(indefinite_action.action.special_effect)
            count += 1
